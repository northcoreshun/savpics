...
label start:
    ...
    leh "А эти твои друзья…\n они с нами в одной комнате были там?"
    "Настя начала рыдать. Лёша просто молчал.\n Для них обоих за последние полчаса мир перевернулся с ног на голову."
    ...
    leh "А Катя с ним встречалась. Правильно говорят,\n девушкам всякие долбоёбы нравится."
    nas "Он раньше другим был. С Катей он прилично\n себя вёл, ну... на людях. Но наедине...\n Катя жаловалась, но я думала она\n просто много требует от отношений."
    ...
    leh "Я не зол на тебя. Думаю, карма тебе\n уже прилетела. Даже с процентами."
    ...
    nas "Да и вообще. Не думаю, что соседи\n или ребята ментов вызывали. Никто там с\n полицией общаться не захочет лишний раз."
    leh "А Андрей и его дружки?"
    nas "Пусть только попробует. Я скажу, что\n он меня изнасиловать пытался."
    nas "Поедет к челу, который Шурыгину трахнул, хахах."
    nas "Ты как? Сильно же он тебя отпиздил."
    leh "Да ничего."
    nas "Может в аптеку схожу? Тут круглосутка\n рядом есть."
    leh "Не надо."
    "Ребята ещё посидели."
